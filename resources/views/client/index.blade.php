                ...
                @foreach ($data['danhmuc'] as $value)
                    <div class="col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="">
                        ...
                        <a class="block-2-item" href="#">
                            <figure class="image">
                                <img src="https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQkrYPidrF9O1B6RkHtn_kvK6360DkFWU15hzxYwsT-_zYoIhq_"
                                    alt="" class="img-fluid">
                            </figure>
                            <div class="text">
                            ...
                            <div class="item">
                                <div class="block-4 text-center">
                                    <figure class="block-4-image">
                                        <img src="{{ Storage::url($value->img) }}" width="150px" alt="Image placeholder"
                                            class="img-fluid">
                                    </figure>
                                    <div class="block-4-text p-4">
                                        <h3><a href="{{ route('product.detail', $value->id) }}">{{ $value->name }}</a></h3>
                                        <p class="mb-0">{{ $value->describe }}</p>
                                        <p class="text-primary font-weight-bold">Giá: {{ number_format($value->price) }} vnd
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-md-12 col-lg-7 mb-5">
                    <a href="#"><img src="{{ url('client/images/blog_1.jpg') }}" alt="Image placeholder"
