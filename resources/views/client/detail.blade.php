                                ...
                                <div class="row">
                                                ...
                                                <div class="col-3">
                                                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                                        ...
                                                        <a class="nav-link active" id="product-1-tab" data-bs-toggle="pill"
                                                            ...
                                                            <img src="{{ Storage::url($sanpham->img) }}" alt=""
                                                        ...
                                                        <div class="tab-pane fade show active" id="product-1"
                                                            ...
                                                            <div class="product-img">
                                                                <img src="{{ Storage::url($sanpham->img) }}" alt=""
                                                                    ...
                                                                    data-zoom="{{ Storage::url($sanpham->img) }}">
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col-xl-7">
                                        <div class="mt-4 mt-xl-3">
                                            ...
                                            {{-- <a href="#" class="text-primary">{{ $sanpham->ten_dm }}</a> --}}
                                            <h5 class="mt-1 mb-3">Tên sản phẩm: {{ $sanpham->name }}</h5>
                                            ...
                                            <h5 class="mt-2">
                                                ...
                                                {{-- <del class="text-muted me-2">$200</del> --}}
                                                Giá: {{ number_format($sanpham->price) }} vnd
                                            ...
                                            <div class="mt-4">
                                                <h6>Phân loại: {{ $sanpham->name }}</h6>

                                                <div class="mt-4">
                                                    <p class="text-muted mb-2">
                                                        <i class="mdi mdi-check-bold text-success me-2"></i>
                                                        Mô tả: {{ $sanpham->describe }}
                                                    </p>
                                            ...
                                            <div class="mt-4">
                                                <form method="POST" action="{{ route('cart.add') }}">
                                                    ...
                                                    <input type="hidden" name="image" value="{{ $sanpham->img }}">
                                                    <div class="input-group mb-3" style="max-width: 120px;">
                                                        <input type="number" name="quantity"
                                                            class="form-control text-center" value="1" min="1">
                                                    </div>
                                                    <button type="submit" class="btn btn-primary"><i
                                                            class="mdi mdi-cart me-2"></i> Add to cart</button>
                                                </form>
                                ...
                                <div class="row">
                                    <div class="col-xl-3">
                                        <div class="product-track rounded p-4">
                                            ...
                                            <p class="text-muted mt-3 mb-0">Passages and more recently with desktop
                                    ...
                                    <div class="col-xl-3">
                                        <div class="product-track rounded p-4">
                                            ...
                                            <p class="text-muted mt-3 mb-0">Itaque earum rerum hic tenetur a sapiente
                                    ...
                                    <div class="media border-bottom pb-3">
                                        <div class="media-body">
                                            ...
                                            <ul class="list-inline product-review-link mb-0">
                                                ...
                                                <li class="list-inline-item">
                                                    <a href="#"><i
                                                            class="mdi mdi-message-text align-middle me-1"></i> Comment</a>
                                                </li>
                                            </ul>
                                        </div>
