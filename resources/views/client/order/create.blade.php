          ...
          <div class="p-3 p-lg-5 border">
            ...
            <div class="form-group row">
              <div class="col-md-12">
                ...
                <input type="text" class="form-control" id="c_address" name="dia_chi_nguoi_nhan" placeholder="Street address">
              </div>
            </div>
{{-- 
            <div class="form-group">
            ...
            <div class="form-group row mb-5">
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="c_phone" name="sdt_nguoi_nhan" placeholder="Phone Number">
              </div>
            </div>
...
{{-- 
            ...
            <div class="form-group">
              ...
              <textarea name="ghi_chu" id="c_order_notes" cols="30" rows="5" class="form-control" placeholder="Write your notes here..."></textarea>
            </div>
          ...
          <div class="row mb-5">
            <div class="col-md-12">
              ...
              <div class="p-3 p-lg-5 border">
                <table class="table site-block-order-table mb-5">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-black">{{ $subTotal }} đ</td>
                    </tr>
                    <tr>
                      <td class="text-black font-weight-bold"><strong>Shipping </strong></td>
                      <td class="text-black font-weight-bold"><strong>{{ $shipping }} đ</strong></td>
                    </tr>
                    <tr>
                ...
                <div class="form-group">
                  <button type="submit" class="btn btn-primary btn-lg py-3 btn-block" onclick="window.location='thankyou.html'">Place Order</button>
                </div>
